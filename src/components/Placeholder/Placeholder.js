...
const PostLoader = props => (<ContentLoader height={350} width={245} speed={2} backgroundColor="#f3f3f3" foregroundColor="#ecebeb">
...
export const SidebarMobileLoader = () => (<ContentLoader height={46} width={400} speed={2} backgroundColor="#f3f3f3" foregroundColor="#ecebeb">
...
export const SidebarLoader = () => (<ContentLoader height={400} width={360} speed={2} backgroundColor="#f3f3f3" foregroundColor="#ecebeb">
